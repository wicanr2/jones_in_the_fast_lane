...
slide "$TMP/01.png" s_copyright.png '啟動畫面：全程繁體中文渲染'
slide "$TMP/02.png" s_board.png     '棋盤地點招牌 · 逐一重繪成中文'
slide "$TMP/03.png" s_dialogue.png  '對白 / 選單 / 訊息 · 776 則全譯'
slide "$TMP/04.png" s_charsel.png   '選擇角色 · 畫面標題也中文化'
slide "$TMP/05.png" s_goals.png     '設定你的目標：財富 · 快樂 · 學歷 · 職業'
card  "$TMP/99.png" '人生劇場' 'ScummVM 繁中化 · 免費開源' 'github.com/wicanr2/jones_in_the_fast_lane'

# ===== concat + 配樂 =====
LIST="$TMP/list.txt"; : > "$LIST"
declare -A DUR=( [00]=5 [01]=6 [02]=7 [03]=7 [04]=6 [05]=7 [99]=6 )
