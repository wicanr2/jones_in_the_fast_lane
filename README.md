...
- **烘字美術**：**標題 logo（人生劇場）**、開場 credits 角色頭銜（執行製作/創意總監/美術/演員…，人名維持原文）、棋盤地點招牌（工廠、銀行、當舖、租屋、Z超商…）、14 個動作按鈕（完成/工作/購買/出售…）、目標畫面橫幅（瓊斯的目標）、選單按鈕（公平競爭/全力一搏）重繪成中文。
...
> 「大家好！我是**幸福人瓊斯**。你想了解我轟轟烈烈的一生嗎？在這裡，你可以窮困潦倒、兩袖清風的
> 過一輩子；也可以叱吒風雲、耀武揚威的度過一生……告訴你，很好玩哦！騙你的話就把我的寶貝老婆給你。」
> —— 當年官方中文手冊，瓊斯的開場白

三十多年前，一群 Sierra 的人把「過日子」做成了一場競賽。你剛搬進小鎮，**渾身上下只有 $200 老本**，
沒有存款、沒有學歷、也沒有工作。從今天起，吃飯、上班、上學、購物、投資——每一件瑣事都算分：

**財富、快樂、學歷、職業**，四項人生目標，誰先全部達標誰就贏。指針轉一圈是一個星期；每週不吃飯會餓昏
送醫，每月忘了付房租房東就從你薪水裡扣，身上帶太多現金還會被扒個精光。你可以單槍匹馬挑戰那個永遠笑
咪咪、跟你搶工作搶名次的電腦對手「瓊斯」，也可以揪上最多 4 個人同鎮廝殺。核心循環很簡單，難的是時間永遠不夠：

> 職業介紹所找工作 → 上班賺錢 → 大學進修解鎖高薪工作 → 銀行存款/投資/貸款 → 商店消費換快樂 →
> 缺錢時當舖典當或買樂透碰運氣。

窮也好、富也好，這遊戲不逼你成功——它只想讓你嚐一口 1990 年那種「把人生濃縮成一張棋盤」的荒謬與樂趣。
完整玩法、四大目標拿分訣竅、十一處地點與過關提示，都整理在 **[中文遊戲手冊](docs/50-manual.md)**。
...
3. 把 `dist/game-cht/` 內全部檔案複製到遊戲目錄：
   ...
   - `0.p56`（標題 logo「人生劇場」）、`1-5.v56`（開場 credits 頭銜）
...
| [docs/50-manual.md](docs/50-manual.md) | **中文遊戲手冊**（軟體世界珍藏版 76 完整整理：前言、操作、四大目標、11 地點、提示） |
